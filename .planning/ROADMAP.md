...
- [x] 26.1-04-PLAN.md — cleanup verification: grep audit toàn sources/ + docker-compose enforce SC5 (zero VNPay UNACCEPTABLE matches); smoke test compile + Playwright list; tạo 26.1-CLEANUP-VERIFY.md ghi log SC5 verdict
