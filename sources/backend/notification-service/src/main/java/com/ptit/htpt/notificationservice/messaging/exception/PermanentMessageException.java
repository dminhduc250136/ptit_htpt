package com.ptit.htpt.notificationservice.messaging.exception;

import org.springframework.amqp.AmqpRejectAndDontRequeueException;

/**
 * D-08: lỗi vĩnh viễn (payload sai format, business invariant vi phạm, recipient không tồn tại).
 * Extend {@link AmqpRejectAndDontRequeueException} để Spring AMQP retry interceptor SKIP retry
 * và route message thẳng vào DLQ (notification.order-events → order.dlx → order-events.dlq).
 *
