...
/**
 * Phase 19 / Plan 19-02 (D-04): time-window enum cho admin chart endpoints (user-svc copy).
 *
 * <p>Mỗi microservice là independent Maven module — KHÔNG shared module trong codebase.
 * Pattern này theo precedent {@code JwtRoleGuard} đã copy per-svc. Source-of-truth analog:
 * {@code com.ptit.htpt.orderservice.service.Range}.
 *
 * <p>Mapping:
 * <ul>
